...
public class PendingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ambil data lokasi pending
        if (boxInfoPref.getInt("locationId", 0) != 0) {
            if (boxInfoPref.getString("area", "").equals("WIP")) {
                getPendingLocation("Lebur");
            } else {
        ...
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (boxInfoPref.getInt("status", 0) == 0) {
                ...
                } else if (boxInfoPref.getInt("status", 0) == 2 || boxInfoPref.getInt("status", 0) == 4) {
                    //saat box sudah di scan dan status box sedang dalam produksi atau pending
                    ...
                    scanBoxPage();
                    new SweetAlertDialog(PendingActivity.this, SweetAlertDialog.WARNING_TYPE)
        ...
        btnScanBox.setOnClickListener(v -> {
            ...
            startActivity(new Intent(PendingActivity.this, ScanActivity.class));
            finish();
        ...
        btnPending.setOnClickListener(v -> {
            if (locationPref.getInt("locationId", 0) == 0) {
                showAlert(SweetAlertDialog.WARNING_TYPE, "Peringatan", "Tidak ada data lokasi untuk pending box ini");
            } else {
                pending(new APIResponseCallback() {
                    @Override
    ...
    public void getPendingLocation(String line) {
        ApiEndPoint apiEndPoint = ApiClient.getClient().create(ApiEndPoint.class);
        Call<LocationResponse> call = apiEndPoint.getPendingLocation(line);
    ...
    public void pending(APIResponseCallback callback) {
        ...
        call.enqueue(new Callback<StatusResponse>() {
            ...
            public void onResponse(Call<StatusResponse> call, Response<StatusResponse> response) {
                ...
                try {
                    ...
                    new SweetAlertDialog(PendingActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                            .setTitleText("Berhasil")
                            .setContentText("Berhasil pending box " + boxInfoPref.getString("boxCode", ""))
                            .setConfirmText("Ok")
                            .setConfirmButtonBackgroundColor(Color.parseColor("#121481"))
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                @Override
                                public void onClick(SweetAlertDialog sDialog) {
                                    clearPref();
                                    sDialog.dismissWithAnimation();
                                    startActivity(new Intent(PendingActivity.this, MenuActivity.class));
                                    finish();
                                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                                }
                            })
    ...
    public void showAlert (int type, String title, String contentText) {
        ...
        new SweetAlertDialog(PendingActivity.this, type)
                .setTitleText(title)
